...
NOTARIZE_BUNDLE_ID=com.keestak.BetterSF
NOTARIZE_BUNDLE_ID_DEMO=com.keestak.BetterSF.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/BetterSF.iss
#  git checkout installer/BetterSF.pkgproj
