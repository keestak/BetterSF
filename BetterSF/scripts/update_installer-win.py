...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=BetterSF Demo Installer\n"
      else:
        line="OutputBaseFilename=BetterSF Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the BetterSF Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the BetterSF installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=BetterSF Demo installer\n"
     else:
       line="SetupWindowTitle=BetterSF installer\n"
